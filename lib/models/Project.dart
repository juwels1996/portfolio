...
List<Project> demo_projects = [
  ...
  Project(
    title: "Google Signin in Firebase",
    description:
        "Firebase Authentication makes building secure sign-ins for any platform easy. This end-to-end solution supports email and passowrd, phone auth, & mult-platform login. Monitor App Performance. Build Fast For Any Device. For Mobile or Web Apps.",
  ),
  Project(
